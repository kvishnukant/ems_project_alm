...
<jsp:useBean  id="entity" class="com.sample.mvc.command.EmployeeCommand" scope="session"></jsp:useBean>
...
<div class="smart-green">
	...
	<br>
	<form method="post" action="<%=request.getContextPath()%>/delete.htm">
		<label>Are you sure for deletion</label><input type="text" name="code" required="required" value="<%=request.getParameter("code") %>" readonly/>
		<br/>
